...
public class mainbook {
    public static void main(String[] args) {
        ...
        book b4 = new book("Hunger Games", 370, "ABDK223", "Fiction", "Suzanne Collins");
        alb.add(b4);
        book b5 = new book("Atomic Habits", 549, "ABCD3101", "Self-Help", "James Clear");
        alb.add(b5);
        book b6 = new book("Seven Years in Tibet", 999, "NA67ZI", "Auto-biography", "Heinrich Harrer");
        alb.add(b6);
        }

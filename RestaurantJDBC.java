...
public class RestaurantJDBC {
    ...
    public static void insertData(Connection con) throws Exception {
        ...
        try (PreparedStatement ps1 = con.prepareStatement(insertRestaurant);
            ...
            Object[][] restaurants = {
                {1, "Buon Cibo", "101 Baner"},
                {2, "Brew Merchant", "202 Hinjewadi"},
                {3, "Burger King", "303 Wakad"},
                {4, "Blue Tokai", "404 KP"},
                {5, "Taco Bell", "505 Maple Dr"},
                {6, "Subway", "606 Viman Nagar"},
                {7, "Gong", "707 BHS"},
                {8, "McDonalds", "808 Walnut St"},
                {9, "Dominos", "909 Cherry Way"},
